...
export const RESEARCH_TREE = {
    Damage: {
        ...
        color: MAGENTA,
        tiers: [
            { id: "dmg_1", name: "Weapons I",  desc: "+8% tower damage",  cost: 900,  time: 12,
              effect: { damage_mult: 0.08 } },
            { id: "dmg_2", name: "Weapons II", desc: "+8% tower damage",  cost: 1900,  time: 20,
              effect: { damage_mult: 0.08 } },
        ],
        branches: {
            A: {
                ...
                children: {
                    1: { id: "dmg_A1", name: "Armor Piercing", desc: "Ignore 50% enemy armor",
                         cost: 9000, time: 40, effect: { armor_pierce: 0.50 } },
                    2: { id: "dmg_A2", name: "Critical Systems", desc: "10% chance to deal double damage",
                         cost: 9000, time: 40, effect: { critical_chance: 0.10 } },
                }
            },
            B: {
                ...
                children: {
                    1: { id: "dmg_B1", name: "Controlled Damage", desc: "+25% damage vs controlled enemies",
                         cost: 9000, time: 40, effect: { controlled_damage_bonus: 0.25 } },
                    2: { id: "dmg_B2", name: "Overdrive", desc: "+15% fire rate",
                         cost: 9000, time: 40, effect: { firerate_bonus: 0.15 } },
                }
            }
        }
    },
    Range: {
        ...
        color: NEON_GREEN,
        tiers: [
            { id: "rng_1", name: "Sensors I",  desc: "+6% tower range",  cost: 800,  time: 12,
              effect: { range_mult: 0.06 } },
            { id: "rng_2", name: "Sensors II", desc: "+6% tower range",  cost: 1800,  time: 20,
              effect: { range_mult: 0.06 } },
        ],
        branches: {
            A: {
                ...
                children: {
                    1: { id: "rng_A1", name: "Phase Scanner", desc: "Phased enemies take normal damage",
                         cost: 8500, time: 40, effect: { phase_scanner: 1 } },
                    2: { id: "rng_A2", name: "Overwatch", desc: "+20% damage beyond 75% range",
                         cost: 8500, time: 40, effect: { overwatch_bonus: 0.20 } },
                }
            },
            B: {
                ...
                children: {
                    1: { id: "rng_B1", name: "Field Amplifier", desc: "Cryo/Nova/Tesla AoE +25%",
                         cost: 8500, time: 40, effect: { aoe_bonus: 0.25 } },
                    2: { id: "rng_B2", name: "Proximity Boost", desc: "+25% damage to enemies within half range",
                         cost: 8500, time: 40, effect: { proximity_bonus: 0.25 } },
                }
            }
        }
    },
    Control: {
        ...
        color: ICE_BLUE,
        tiers: [
            { id: "ctl_1", name: "Disruption I",  desc: "+10% slow/vuln/dot", cost: 950,  time: 12,
              effect: { control_mult: 0.10 } },
            { id: "ctl_2", name: "Disruption II", desc: "+10% slow/vuln/dot", cost: 2100,  time: 20,
              effect: { control_mult: 0.10 } },
        ],
        branches: {
            A: {
                ...
                children: {
                    1: { id: "ctl_A1", name: "Deep Freeze", desc: "Slow effects last 50% longer",
                         cost: 9500, time: 40, effect: { slow_duration_mult: 0.50 } },
                    2: { id: "ctl_A2", name: "Shatter", desc: "Enemies below 30% HP take +40% damage",
                         cost: 9500, time: 40, effect: { execute_threshold: 0.30, execute_bonus: 0.40 } },
                }
            },
            B: {
                ...
                children: {
                    1: { id: "ctl_B1", name: "Cascade", desc: "DoT +60%, tick +30%, spreads on kill",
                         cost: 9500, time: 40, effect: { dot_damage_bonus: 0.60, dot_tick_bonus: 0.30, cascade_spread: 1 } },
                    2: { id: "ctl_B2", name: "Suppression Field", desc: "Controlled enemies deal 30% less to towers",
                         cost: 9500, time: 40, effect: { suppression_field: 0.30 } },
                }
            }
        }
    },
    Fortify: {
        ...
        color: CYAN,
        tiers: [
            { id: "frt_1", name: "Reinforce I",  desc: "+12% tower HP",  cost: 750,  time: 12,
              effect: { fortify_mult: 0.12 } },
            { id: "frt_2", name: "Reinforce II", desc: "+12% tower HP",  cost: 1700,  time: 20,
              effect: { fortify_mult: 0.12 } },
        ],
        branches: {
            A: {
                ...
                children: {
                    1: { id: "frt_A1", name: "Reactive Armor", desc: "Towers take 40% less sapper damage",
                         cost: 7800, time: 40, effect: { sapper_reduction: 0.40 } },
                    2: { id: "frt_A2", name: "Auto-Repair", desc: "Towers regen 1.5% max HP/sec",
                         cost: 7800, time: 40, effect: { tower_regen: 0.015 } },
                }
            },
            B: {
                ...
                children: {
                    1: { id: "frt_B1", name: "Emergency Overhaul", desc: "Destroyed towers refund 75%, rebuild same type 50% faster",
                         cost: 7800, time: 40, effect: { destroy_refund: 0.75, rebuild_speed: 0.50 } },
                    2: { id: "frt_B2", name: "Active Construction", desc: "Towers operate at 50% while building/upgrading",
                         cost: 7800, time: 40, effect: { active_construction: 0.50 } },
                }
            }
        }
    },
