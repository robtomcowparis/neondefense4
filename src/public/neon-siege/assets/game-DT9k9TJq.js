...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function VM(n,t,e){const i=new Float32Array(qs),s=new F(0,1,0);return new En({name:"SphericalGaussianBlur",defines:{n:qs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Sl(),fragmentShader:`
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function ju(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sl(),fragmentShader:`
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function Ku(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Sl(),fragmentShader:`
...
`].filter(gr).join(`
`)),r=Md(r),r=lf(r,e),r=cf(r,e),o=Md(o),o=lf(o,e),o=cf(o,e),r=df(r),o=df(o),e.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`)+`
`+p);const M=v+m+r,y=v+p+o,T=af(s,s.VERTEX_SHADER,M),b=af(s,s.FRAGMENT_SHADER,y);s.attachShader(g,T),s.attachShader(g,b),e.index0AttributeName!==void 0?s.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function A(P){if(n.debug.checkShaderErrors){const N=s.getProgramInfoLog(g)||"",L=s.getShaderInfoLog(T)||"",k=s.getShaderInfoLog(b)||"",B=N.trim(),V=L.trim(),H=k.trim();let et=!0,tt=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(et=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,g,T,b);else{const ht=of(s,T,"vertex"),ot=of(s,b,"fragment");fe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
...
void main() {
  ...
  `,In.appendChild(b),$.rallySection=b,$.rallyCount=b.querySelector(".rally-count"),$.rallyFill=b.querySelector(".rally-fill"),$.rallyTimer=b.querySelector(".rally-timer"),b.querySelector(".rally-push-btn").addEventListener("click",()=>{vt&&vt.onPushNow&&vt.onPushNow()});const x=Ta("MAP"),S=document.createElement("canvas");S.className="minimap-canvas",S.width=is,S.height=is,x.appendChild(S),In.appendChild(x),$.minimapCanvas=S,$.minimapCtx=S.getContext("2d"),S.addEventListener("click",L=>{const k=S.getBoundingClientRect(),B=is/k.width,V=is/k.height,H=(L.clientX-k.left)*B,et=(L.clientY-k.top)*V,tt=H/vn,ht=et/vn;if(za!=null&&vt&&vt.onRallySet){vt.onRallySet(za,tt,ht),za=null;return}if(ts&&vt&&vt.onHelicopterRally){vt.onHelicopterRally(ts.id,tt,ht),wn(),vt.onHeliDeselect&&vt.onHeliDeselect();return}vt&&vt.onMinimapClick&&vt.onMinimapClick(tt,ht)});const I=Ta("INFO"),P=document.createElement("div");P.className="info-panel",P.textContent="Click a building type to place it.",I.appendChild(P),In.appendChild(I),$.infoPanel=P;const N=document.createElement("div");N.className="match-timer",N.textContent="00:00",In.appendChild(N),$.matchTimer=N}function Vb(n){if(!$.energyValue)return;if($.energyValue.textContent=Math.floor(n.energy),n.incomeBreakdown&&$.incomeNet){const i=n.incomeBreakdown,s=i.net>=0?"+":"";$.incomeNet.textContent=`${s}${i.net.toFixed(1)}/s`,$.incomeNet.className="income-net"+(i.net<=0?" income-low":""),$.incGen.textContent=i.generators>0?`+${i.generators.toFixed(1)}`:"+0",$.incTerr.textContent=i.territory>0?`+${i.territory.toFixed(1)}`:"+0"}let t=null,e=null;if(n.buildings)for(const i of n.buildings)i.type===Nn&&i.team===st&&(t=i),i.type===Nn&&i.team===Kt&&(e=i);if(t){const i=Qt[Nn],s=Math.max(0,t.hp/i.hp);$.playerHpFill.style.width=s*100+"%",$.playerHpFill.className="hp-bar-fill "+Id(s),$.playerHpLabel.textContent=`${Math.ceil(t.hp)} / ${i.hp}`}if(e){const i=Qt[Nn],s=Math.max(0,e.hp/i.hp);$.enemyHpFill.style.width=s*100+"%",$.enemyHpFill.className="hp-bar-fill "+Id(s),$.enemyHpLabel.textContent=`${Math.ceil(e.hp)} / ${i.hp}`}if(n.matchTime!=null){const i=Math.floor(n.matchTime),s=Math.floor(i/60),a=i%60;$.matchTimer.textContent=String(s).padStart(2,"0")+":"+String(a).padStart(2,"0")}for(const i of Xf){const s=Qt[i],a=$.buildButtons[i];a&&(n.energy<s.cost?a.classList.add("disabled"):a.classList.remove("disabled"))}if(n.units){let i=0,s=0;for(const a of n.units)a.team===st?i++:s++;$.playerUnitCount.textContent=i,$.enemyUnitCount.textContent=s}if($b(n),Yb(n),Zb(n),$.airStrikeOverlay){const i=Bo||n.airStrikePending;$.airStrikeOverlay.classList.toggle("hidden",!i),document.body.classList.toggle("airstrike-targeting",!!i),!n.airStrikePending&&Bo&&(Bo=!1)}jb(n.baseUnderAttack,n.dt||0),Kb(n),Jb(n),xi&&xm(xi,n.energy,n.squads,n.matchTime),ts&&ts.alive?_m(ts):ts&&!ts.alive&&(wn(),vt&&vt.onHeliDeselect&&vt.onHeliDeselect())}function Wb(n){n&&(ts=n,hn(),Ji(),$.heliSection.classList.remove("hidden"),_m(n))}function wn(){ts=null,$.heliSection&&$.heliSection.classList.add("hidden")}function _m(n){const t=Go[n.type];if(!t)return;const e=n.maxHp||t.hp,i=Math.max(0,n.hp/e);$.heliHpValue.textContent=`${Math.ceil(n.hp)} / ${e}`,$.heliHpFill.style.width=i*100+"%",$.heliHpFill.className="hp-bar-fill "+Id(i)}function gm(n){if(!n||n.team!==st){hn();return}if(!Qt[n.type]){hn();return}xi=n,Ji(),wn(),$.buildingSection.classList.remove("hidden"),xm(n,0)}function hn(){xi=null,nr="",$.buildingSection&&$.buildingSection.classList.add("hidden")}function rl(){return xi}function xm(n,t,e,i){if(!n||!n.alive){hn();return}const s=Qt[n.type];if(n.type===Wt)$.buildingTitle.textContent=`WALL L${n.level}`;else{let r=s.label.toUpperCase();if(e&&(n.type===Je||n.type===Xe||n.type===on)){const o=e.find(d=>d.buildingId===n.id);o&&(r=o.label.toUpperCase())}$.buildingTitle.textContent=r}if(s.levels){let r=`Level ${n.level}`;if(n.type===Wt)r=s.description||"Destructible barrier";else if(n.branch){const o=s.branches[n.branch];r=`[${n.branch}] ${o.name}`}$.buildingLevel.textContent=r,$.buildingLevel.className="building-level"+(n.branch?" building-branched":"")}else $.buildingLevel.textContent=s.description||"",$.buildingLevel.className="building-level";let a="";if(n.type===ke){const r=rm(n);r&&(a+=`<div class="info-stat"><span>DMG</span><span class="info-stat-value">${r.damage}</span></div>`,a+=`<div class="info-stat"><span>RATE</span><span class="info-stat-value">${r.fireRate.toFixed(2)}s</span></div>`,a+=`<div class="info-stat"><span>RANGE</span><span class="info-stat-value">${r.range}</span></div>`,r.splashRadius&&(a+=`<div class="info-stat"><span>SPLASH</span><span class="info-stat-value">${r.splashRadius}px</span></div>`))}else if(n.type===Be){const r=lm(n);r&&(a+=`<div class="info-stat"><span>INCOME</span><span class="info-stat-value income-gen">+${r.incomeBonus}/s</span></div>`,r.territoryMult>1&&(a+=`<div class="info-stat"><span>TERRITORY MULT</span><span class="info-stat-value income-gen">x${r.territoryMult}</span></div>`))}else if(n.type===Wt)a+='<div class="info-stat"><span>TYPE</span><span class="info-stat-value">BARRIER</span></div>';else{const r=om(n);if(r){const o=r.produceUnit||s.produceUnit;a+=`<div class="info-stat"><span>UNIT</span><span class="info-stat-value">${o.toUpperCase()}</span></div>`,a+=`<div class="info-stat"><span>RATE</span><span class="info-stat-value">${r.produceTime.toFixed(1)}s</span></div>`,r.hpMult&&r.hpMult!==1&&(a+=`<div class="info-stat"><span>UNIT HP</span><span class="info-stat-value">+${Math.round((r.hpMult-1)*100)}%</span></div>`),r.damageMult&&r.damageMult!==1&&(a+=`<div class="info-stat"><span>UNIT DMG</span><span class="info-stat-value">+${Math.round((r.damageMult-1)*100)}%</span></div>`),r.speedMult&&r.speedMult!==1&&(a+=`<div class="info-stat"><span>UNIT SPD</span><span class="info-stat-value">+${Math.round((r.speedMult-1)*100)}%</span></div>`),r.rangeMult&&r.rangeMult!==1&&(a+=`<div class="info-stat"><span>UNIT RNG</span><span class="info-stat-value">+${Math.round((r.rangeMult-1)*100)}%</span></div>`)}}if(a+=`<div class="info-stat"><span>HP</span><span class="info-stat-value">${Math.ceil(n.hp)} / ${n.maxHp}</span></div>`,$.buildingStats.innerHTML=a,n.type===ke?$.buildingTracker.innerHTML=`<div class="info-stat"><span>Dmg dealt</span><span class="info-stat-value">${n.totalDamage}</span></div><div class="info-stat"><span>Kills</span><span class="info-stat-value">${n.kills}</span></div>`:$.buildingTracker.innerHTML="",s.levels)if(n.constructionState&&n.constructionState!=="building"){$.buildingConstruction.classList.remove("hidden");const r=Math.min(1,n.constructionTimer/n.constructionDuration),o=Math.max(0,n.constructionDuration-n.constructionTimer).toFixed(1);let d="UPGRADING",c="construction-upgrade";n.constructionState==="branching"?(d="BRANCHING",c="construction-branch"):n.constructionState==="repairing"&&(d="REPAIRING",c="construction-repair"),$.constructionLabel.textContent=`${d}... ${o}s`,$.constructionFill.style.width=r*100+"%",$.constructionFill.className="hp-bar-fill "+c,$.buildingActions.innerHTML="",nr=""}else $.buildingConstruction.classList.add("hidden"),Xb(n,t,i);else $.buildingConstruction.classList.add("hidden"),$.buildingActions.innerHTML="",nr=""}function Xb(n,t,e){const i=Xr(n),s=n.type!==Wt&&qr(n),a=i?bh(n):0,r=i&&t>=a;let o=!1,d=!1;s&&(o=t>=vr(n,"A"),d=t>=vr(n,"B"));const c=n.type===Wt,h=c&&n.hp<n.maxHp&&!n.constructionState,l=c?Qt[Wt].repairCost||10:0,u=h&&t>=l,f=sl(n,e||0),_=f&&t>=Va,g=n.airStrikeCooldownUntil&&e?Math.max(0,n.airStrikeCooldownUntil-e):0,m=`${n.id}:${n.level}:${n.branch}:${i}:${s}:${r}:${o}:${d}:${h}:${u}:${Math.ceil(n.hp)}:${n.orientation||""}:${f}:${_}:${Math.floor(g)}`;if(m===nr)return;nr=m;let p="";if(c){const v=[{key:na,label:"H"},{key:ko,label:"V"},{key:kd,label:"NE"},{key:Vd,label:"NW"},{key:Wd,label:"SE"},{key:Xd,label:"SW"}],M=n.orientation||na;p+='<div class="wall-orient-row">';for(const y of v){const T=M===y.key?" active":"";p+=`<button class="wall-orient-btn${T}" data-action="orient" data-orient="${y.key}">${y.label}</button>`}p+="</div>"}if(h&&(p+=`<button class="build-btn turret-action-btn repair-btn ${u?"":"disabled"}" data-action="repair">
    ...
    </div>`}$.squadCards.innerHTML=a,$.squadCards.querySelectorAll("[data-squad-click]").forEach(r=>{r.addEventListener("click",()=>{const o=Number(r.dataset.squadClick);vt&&vt.onSquadCardClick&&vt.onSquadCardClick(o)})}),$.squadCards.querySelectorAll('[data-spawn="stance"]').forEach(r=>{r.addEventListener("click",()=>{vt&&vt.onSpawnStanceChange&&vt.onSpawnStanceChange(Number(r.dataset.squadId),r.dataset.val)})}),$.squadCards.querySelectorAll('[data-spawn="target"]').forEach(r=>{r.addEventListener("click",()=>{vt&&vt.onSpawnTargetChange&&vt.onSpawnTargetChange(Number(r.dataset.squadId),r.dataset.val)})})}let xc="";function $b(n){const t=n.selectedUnitCount||0;if(t===0){$.selCmdSection&&!$.selCmdSection.classList.contains("hidden")&&$.selCmdSection.classList.add("hidden"),xc="";return}$.selCmdSection.classList.remove("hidden");const e=`${t}`;e!==xc&&(xc=e,$.selCmdTitle.textContent=`${t} UNIT${t!==1?"S":""} SELECTED`)}function Zb(n){const t=n.selectionBoxScreen;if(!t){$.selBoxOverlay&&!$.selBoxOverlay.classList.contains("hidden")&&$.selBoxOverlay.classList.add("hidden");return}$.selBoxOverlay.classList.remove("hidden"),$.selBoxOverlay.style.left=t.x1+"px",$.selBoxOverlay.style.top=t.y1+"px",$.selBoxOverlay.style.width=t.x2-t.x1+"px",$.selBoxOverlay.style.height=t.y2-t.y1+"px"}function jb(n,t){So>0&&(So-=t),n&&!Lf&&So<=0&&(_c=!0,gc=3,So=5,$.baseAlert.classList.remove("hidden"),$.playerHpTrack.classList.add("hp-bar-alert")),_c&&(gc-=t,(gc<=0||!n)&&(_c=!1,$.baseAlert.classList.add("hidden"),$.playerHpTrack.classList.remove("hp-bar-alert"))),Lf=!!n}function Kb(n){if(!(n.rallyActive&&n.rallyHoldingCount>0)){$.rallySection&&!$.rallySection.classList.contains("hidden")&&$.rallySection.classList.add("hidden");return}$.rallySection.classList.remove("hidden");const e=n.rallyHoldingCount||0,i=n.rallyPushSize||1,s=n.rallyTimeRemaining||0;$.rallyCount.textContent=`${e} / ${i}`,$.rallyFill.style.width=e/i*100+"%",$.rallyTimer.textContent=`Push in ${s.toFixed(1)}s`}function Jb(n){const t=$.minimapCtx;if(!t)return;if(t.fillStyle="#08081A",t.fillRect(0,0,is,is),n.obstacles){t.fillStyle="#505064";const s=J*vn;for(const a of n.obstacles)t.fillRect(a.col*s,a.row*s,s,s)}const e=Wf*J*vn,i=(hl+1)*J*vn;if(t.strokeStyle="rgba(0,255,255,0.25)",t.lineWidth=1,t.beginPath(),t.moveTo(0,e),t.lineTo(is,e),t.stroke(),t.strokeStyle="rgba(255,50,50,0.25)",t.beginPath(),t.moveTo(0,i),t.lineTo(is,i),t.stroke(),n.buildings)for(const s of n.buildings){if(!s.alive)continue;const a=Qt[s.type],r=(a?a.size:1)*J*vn;t.fillStyle=s.team===st?"#00ffff":"#ff3232",t.fillRect(s.col*J*vn,s.row*J*vn,r,r)}if(n.units)for(const s of n.units){if(!s.alive)continue;const a=s.team===st?"#00ffff":"#ff3232",r=s.x*vn,o=s.z*vn;s.isAir?(t.fillStyle=a,t.beginPath(),t.moveTo(r,o-3),t.lineTo(r-2.5,o+2),t.lineTo(r+2.5,o+2),t.closePath(),t.fill()):(t.fillStyle=a,t.beginPath(),t.arc(r,o,2,0,Math.PI*2),t.fill())}if(n.squads)for(const s of n.squads){if(s.stance!==ta||s.rallyX==null)continue;const a=s.rallyX*vn,r=s.rallyZ*vn;t.strokeStyle="#32ff64",t.lineWidth=1.5,t.beginPath(),t.moveTo(a,r-4),t.lineTo(a+4,r),t.lineTo(a,r+4),t.lineTo(a-4,r),t.closePath(),t.stroke()}if(n.cameraInfo){const s=n.cameraInfo;t.strokeStyle="rgba(255,255,255,0.5)",t.lineWidth=1;const a=(s.x-s.viewWidth/2)*vn,r=(s.z-s.viewHeight/2)*vn,o=s.viewWidth*vn,d=s.viewHeight*vn;t.strokeRect(a,r,o,d)}}let ol=null,Al=null,Fr=null,yr=null,Re=null,Ii=null,Or=null,js=null,Ld=null;const vm=new Ti(new F(0,1,0),0),Qb=new Ti(new F(0,1,0),-fl),vc=new F,Mc=new F;let Si=null,Ud=null,Nd=null,rs=null,Fd=null,Fi=null,Od=null,Us=!1,ll=null,ir=[],Bd=null,zd=null,An=null,Mi=null,ls=!1,cs=null;function tw(n,t,e){ol=n,Al=t,cs=e||null,Fr=new Pp,yr=new Pt;const i=ol.domElement;i.addEventListener("mousemove",ew),i.addEventListener("mousedown",nw),i.addEventListener("mouseup",iw),i.addEventListener("contextmenu",rw),document.addEventListener("keydown",aw)}function ew(n){const t=ol.domElement.getBoundingClientRect();if(yr.x=(n.clientX-t.left)/t.width*2-1,yr.y=-((n.clientY-t.top)/t.height)*2+1,Fr.setFromCamera(yr,Al),Fr.ray.intersectPlane(vm,vc)?Re=Ln(vc.x,vc.z,J):Re=null,Us&&ll&&Re&&(ir=sw(ll,Re)),An){Mi={x:n.clientX,y:n.clientY};const i=n.clientX-An.x,s=n.clientY-An.y;!ls&&Math.sqrt(i*i+s*s)>t_&&(ls=!0,cs&&(cs.enabled=!1))}}function nw(n){if(n.button===0){if(Ii===Wt&&Re){Us=!0,ll={col:Re.col,row:Re.row},ir=[{col:Re.col,row:Re.row}],cs&&(cs.enabled=!1);return}!Ii&&!Us&&rs==null&&Fi==null&&Si==null&&(An={x:n.clientX,y:n.clientY},Mi=null,ls=!1)}}function iw(n){if(n.button===0){if(Us){ir.length>0&&Bd&&Bd(ir),Ch();return}if(ls&&An&&Mi){const t=ol.domElement.getBoundingClientRect(),e=Ff(An.x,An.y,t),i=Ff(Mi.x,Mi.y,t);if(e&&i&&zd){const s=Math.min(e.x,i.x),a=Math.min(e.z,i.z),r=Math.max(e.x,i.x),o=Math.max(e.z,i.z);zd(s,a,r,o)}cl();return}if(cl(),Fi!=null&&Re){const t=Re.col*J+J/2,e=Re.row*J+J/2;Od&&Od(Fi,t,e),Fi=null;return}if(rs!=null&&Re){const t=Re.col*J+J/2,e=Re.row*J+J/2;Fd&&Fd(rs,t,e),rs=null;return}if(Si!=null&&Re){const t=Re.col*J+J/2,e=Re.row*J+J/2;Ud&&Ud(Si,t,e),Si=null;return}if(!Ii&&Nd&&(Fr.setFromCamera(yr,Al),Fr.ray.intersectPlane(Qb,Mc))){const e=Nd();for(const i of e)if(se(Mc.x,Mc.z,i.x,i.z)<35){Si=i.id,js&&js(-2,-2,0,0);return}}if(Ii&&Re&&Or)Or(Re.col,Re.row,Ii);else if(!Ii&&Re&&js){const t=Re.col*J+J/2,e=Re.row*J+J/2;js(Re.col,Re.row,t,e)}}}function sw(n,t){const e=[],i=t.col-n.col,s=t.row-n.row;if(Math.abs(i)>=Math.abs(s)){const a=Math.min(n.col,t.col),r=Math.max(n.col,t.col);for(let o=a;o<=r;o++)e.push({col:o,row:n.row})}else{const a=Math.min(n.row,t.row),r=Math.max(n.row,t.row);for(let o=a;o<=r;o++)e.push({col:n.col,row:o})}return e}function Ch(){Us=!1,ll=null,ir=[],cs&&(cs.enabled=!0)}function cl(){const n=ls;An=null,Mi=null,ls=!1,n&&cs&&(cs.enabled=!0)}function Ff(n,t,e){const i=new Pt((n-e.left)/e.width*2-1,-((t-e.top)/e.height)*2+1),s=new Pp;s.setFromCamera(i,Al);const a=new F;return s.ray.intersectPlane(vm,a)?{x:a.x,z:a.z}:null}function aw(n){if((n.key==="h"||n.key==="H"||n.key==="Home")&&Ld&&Ld(),n.key==="Escape"){if(ls||An){cl();return}if(Us){Ch();return}if(Fi!=null){Fi=null;return}if(rs!=null){rs=null;return}Si!=null&&(Si=null)}}function rw(n){if(n.preventDefault(),ls||An){cl();return}if(Us){Ch();return}if(Fi!=null){Fi=null;return}if(rs!=null){rs=null;return}if(Si!=null){Si=null;return}Ii?(Ii=null,Or&&Or(-1,-1,null)):js&&js(-1,-1)}function ow(){return Re}function vs(n){Ii=n}function lw(){return Ii}function cw(n){Or=n}function dw(n){js=n}function hw(n){Ld=n}function uw(n){Ud=n}function fw(n){Nd=n}function Qi(n){Si=n}function Sr(){return Si}function pw(n){Fd=n}function Ss(n){rs=n}function mw(n){Od=n}function Mm(n){Fi=n}function _w(){return Fi}function gw(n){Bd=n}function xw(){return ir}function vw(){return Us}function Mw(n){zd=n}function yw(){return!ls||!An||!Mi?null:{x1:Math.min(An.x,Mi.x),y1:Math.min(An.y,Mi.y),x2:Math.max(An.x,Mi.x),y2:Math.max(An.y,Mi.y)}}const an=[];let Oi=0;function ym(){an.length=0,Oi=0}function Sw(){an.length=0}function Ew(){return an}function Ci(n,t,e,i){switch(i){case"explosion":Eo(n,t,e,8,12,60,.4,.7,3);break;case"bigExplosion":Eo(n,t,e,15,20,90,.5,1,5);break;case"hit":Eo(n,t,e,3,5,40,.2,.4,2);break;case"muzzleFlash":bw(n,t,e,1,2,.08,.15,4);break;case"wallBreak":ww(n,t,e);break;case"wallHit":Tw(n,t,e);break;case"wallRepair":Aw(n,t,e);break;case"airStrike":Rw(n,t,e);break;default:Eo(n,t,e,4,6,50,.3,.5,2)}}function Eo(n,t,e,i,s,a,r,o,d){const c=i+Math.floor(Math.random()*(s-i+1));for(let h=0;h<c;h++){const l=Math.random()*Math.PI*2,u=a*(.3+Math.random()*.7),f=r+Math.random()*(o-r);an.push({id:Oi++,x:n,y:10+Math.random()*10,z:t,vx:Math.cos(l)*u,vy:20+Math.random()*40,vz:Math.sin(l)*u,color:e,life:f,maxLife:f,size:d*(.6+Math.random()*.4),type:"burst"})}}function bw(n,t,e,i,s,a,r,o){const d=i+Math.floor(Math.random()*(s-i+1));for(let c=0;c<d;c++){const h=a+Math.random()*(r-a);an.push({id:Oi++,x:n+(Math.random()-.5)*4,y:12+Math.random()*6,z:t+(Math.random()-.5)*4,vx:0,vy:5,vz:0,color:e,life:h,maxLife:h,size:o*(.8+Math.random()*.4),type:"flash"})}}function ww(n,t,e){const i=8+Math.floor(Math.random()*5);for(let s=0;s<i;s++){const a=Math.random()*Math.PI*2,r=40+Math.random()*50,o=.5+Math.random()*.3;an.push({id:Oi++,x:n+(Math.random()-.5)*20,y:8+Math.random()*16,z:t+(Math.random()-.5)*20,vx:Math.cos(a)*r,vy:30+Math.random()*50,vz:Math.sin(a)*r,color:e,life:o,maxLife:o,size:3.5+Math.random()*2.5,type:"wallBreak",rotSpeed:(Math.random()-.5)*10})}}function Tw(n,t,e){const i=2+Math.floor(Math.random()*2);for(let s=0;s<i;s++){const a=Math.random()*Math.PI*2,r=25+Math.random()*30,o=.15+Math.random()*.1;an.push({id:Oi++,x:n+(Math.random()-.5)*8,y:10+Math.random()*10,z:t+(Math.random()-.5)*8,vx:Math.cos(a)*r,vy:15+Math.random()*25,vz:Math.sin(a)*r,color:e,life:o,maxLife:o,size:2+Math.random()*1.5,type:"wallHit"})}an.push({id:Oi++,x:n,y:14,z:t,vx:0,vy:3,vz:0,color:16777215,life:.12,maxLife:.12,size:5,type:"flash"})}function Aw(n,t,e){const i=6+Math.floor(Math.random()*3);for(let s=0;s<i;s++){const a=.3+Math.random()*.2;an.push({id:Oi++,x:n+(Math.random()-.5)*24,y:Math.random()*8,z:t+(Math.random()-.5)*24,vx:(Math.random()-.5)*10,vy:40+Math.random()*30,vz:(Math.random()-.5)*10,color:e,life:a,maxLife:a,size:2.5+Math.random()*1.5,type:"wallRepair"})}}function Rw(n,t,e){const i=25+Math.floor(Math.random()*10);for(let a=0;a<i;a++){const r=Math.random()*Math.PI*2,o=60+Math.random()*100,d=.6+Math.random()*.5;an.push({id:Oi++,x:n+(Math.random()-.5)*30,y:5+Math.random()*20,z:t+(Math.random()-.5)*30,vx:Math.cos(r)*o,vy:50+Math.random()*80,vz:Math.sin(r)*o,color:16777215,life:d,maxLife:d,size:5+Math.random()*4,type:"burst"})}const s=30+Math.floor(Math.random()*15);for(let a=0;a<s;a++){const r=Math.random()*Math.PI*2,o=80+Math.random()*140,d=.8+Math.random()*.7;an.push({id:Oi++,x:n+(Math.random()-.5)*60,y:10+Math.random()*30,z:t+(Math.random()-.5)*60,vx:Math.cos(r)*o,vy:30+Math.random()*60,vz:Math.sin(r)*o,color:e,life:d,maxLife:d,size:4+Math.random()*3,type:"wallBreak",rotSpeed:(Math.random()-.5)*12})}for(let a=0;a<5;a++)an.push({id:Oi++,x:n+(Math.random()-.5)*10,y:5+a*15,z:t+(Math.random()-.5)*10,vx:0,vy:60+Math.random()*40,vz:0,color:16768324,life:.3+Math.random()*.2,maxLife:.5,size:8+Math.random()*4,type:"flash"})}function Cw(n){let t=0;for(;t<an.length;){const e=an[t];if(e.life-=n,e.life<=0){an[t]=an[an.length-1],an.pop();continue}e.x+=e.vx*n,e.y+=e.vy*n,e.z+=e.vz*n,e.type==="burst"?e.vy-=60*n:e.type==="wallBreak"?e.vy-=120*n:e.type==="wallHit"&&(e.vy-=80*n),e.y<0&&(e.y=0,e.vy=0),t++}}let yc=null;function Pw(){return yc||(yc=new(window.AudioContext||window.webkitAudioContext)),yc}function jt(n,t,e,i,s,a=0){const r=n.createOscillator(),o=n.createGain();r.type=i,r.frequency.value=t;const d=n.currentTime+a;o.gain.setValueAtTime(s,d),o.gain.exponentialRampToValueAtTime(.001,d+e),r.connect(o),o.connect(n.destination),r.start(d),r.stop(d+e+.01)}function hi(n,t,e,i,s="lowpass"){const a=n.sampleRate,r=Math.floor(a*t),o=n.createBuffer(1,r,a),d=o.getChannelData(0);for(let l=0;l<r;l++)d[l]=Math.random()*2-1;const c=n.createBufferSource();c.buffer=o;const h=n.createGain();if(h.gain.setValueAtTime(e,n.currentTime),h.gain.exponentialRampToValueAtTime(.001,n.currentTime+t),i){const l=n.createBiquadFilter();l.type=s,l.frequency.value=i,c.connect(l),l.connect(h)}else c.connect(h);h.connect(n.destination),c.start()}function Yt(n){const t=Pw();switch(n){case"build":jt(t,440,.1,"sine",.3),jt(t,660,.1,"sine",.2,.1);break;case"build_generator":jt(t,220,.15,"sine",.25),jt(t,330,.12,"sine",.2,.1),jt(t,440,.15,"triangle",.25,.2),jt(t,660,.2,"sine",.15,.3);break;case"denied":jt(t,200,.15,"sawtooth",.3);break;case"shoot":hi(t,.05,.4,2e3,"bandpass");break;case"explosion":hi(t,.3,.5,500,"lowpass");break;case"bigExplosion":hi(t,.5,.7,300,"lowpass");break;case"hit":hi(t,.04,.25,3e3,"bandpass");break;case"victory":jt(t,523,.15,"sine",.3,0),jt(t,659,.15,"sine",.3,.15),jt(t,784,.15,"sine",.3,.3),jt(t,1047,.25,"sine",.35,.45);break;case"defeat":jt(t,440,.15,"sawtooth",.25,0),jt(t,370,.15,"sawtooth",.25,.15),jt(t,311,.2,"sawtooth",.25,.3),jt(t,247,.35,"sawtooth",.3,.5);break;case"select":jt(t,880,.06,"sine",.15);break;case"cancel":jt(t,330,.08,"triangle",.15);break;case"shoot_pulse":jt(t,880,.06,"sine",.6);break;case"upgrade":jt(t,523,.1,"sine",.25,0),jt(t,659,.1,"sine",.25,.1),jt(t,784,.12,"sine",.3,.2);break;case"baseAlert":jt(t,880,.08,"sawtooth",.4),jt(t,440,.12,"sawtooth",.35,.08);break;case"shoot_heli":hi(t,.04,.3,4e3,"highpass"),jt(t,1200,.03,"square",.15);break;case"heli_select":jt(t,660,.06,"sine",.2),jt(t,990,.08,"sine",.25,.06);break;case"heli_rally":jt(t,1320,.1,"sine",.2),jt(t,880,.06,"triangle",.15,.08);break;case"wall_build":hi(t,.08,.35,1200,"bandpass"),jt(t,180,.1,"square",.2,.03),jt(t,260,.06,"triangle",.15,.1);break;case"wall_repair":jt(t,330,.1,"sine",.2),jt(t,440,.1,"sine",.2,.08),jt(t,550,.12,"triangle",.15,.16);break;case"wall_break":hi(t,.4,.5,400,"lowpass"),jt(t,120,.15,"sawtooth",.3),jt(t,80,.25,"square",.2,.1);break;case"airstrike_incoming":jt(t,80,.8,"sawtooth",.15),jt(t,120,.6,"sawtooth",.2,.3),jt(t,180,.5,"sawtooth",.25,.6),hi(t,1.2,.2,600,"lowpass");break;case"airstrike_explosion":hi(t,1,.8,200,"lowpass"),jt(t,40,.8,"sine",.5),jt(t,60,.6,"sawtooth",.3,.05),hi(t,.5,.5,400,"lowpass"),jt(t,30,1,"sine",.3,.1);break;case"airstrike_confirm":jt(t,880,.08,"square",.3),jt(t,660,.08,"square",.25,.1),jt(t,440,.12,"square",.3,.2),hi(t,.15,.15,2e3,"bandpass");break}}let Br=dl,Of=0,Xn=0,Hd=!1,Sm=null,je=[],Er=[],Ha=[];const Dw=document.getElementById("menu-overlay"),Iw=document.getElementById("pause-overlay"),Lw=document.getElementById("victory-overlay"),Uw=document.getElementById("defeat-overlay");function Ns(n){Br=n,Dw.classList.toggle("hidden",n!==dl),Iw.classList.toggle("hidden",n!==Sc),Lw.classList.toggle("hidden",n!==kf),Uw.classList.toggle("hidden",n!==Vf)}function Ph(){Em(),Nw(),Ns(Ga)}function Em(){const n=He();if(n){for(const t of qn())Wr(t,n);for(const t of Le())yh(t,n);for(const t of Dd())am(t,n)}Xn=0,Hd=!1,ab(),db(),mb(),Sw(),Eb(),Gb(),T_(),Yp(),je=[];for(const t of Ha)t.mesh&&n&&sm(t.mesh,n);Er=[],Ha=[],Mm(null),hn(),wn(),Qi(null),ys(null),Ss(null),ym(),R1()}function Nw(){const n=il(Nn,ws,es,st);Lr(n,He());const t=il(Nn,si,Tn,Kt);Lr(t,He()),W1(He()),Mb(window._selectedDifficulty||"normal"),bb(window._selectedDifficulty||"normal"),Sm=P1(),Ji(),vs(null)}function Bf(n,t,e){if(!e)return!1;const i=Qt[e];if(!i)return!1;if(Mr(st)<i.cost||!el(n,t,i.size,st))return Yt("denied"),!1;if(!tr(st,i.cost))return!1;const a=il(e,n,t,st);return Lr(a,He()),(e===Je||e===Xe||e===on)&&Qf(a.id,st,e),Yt(e===Wt?"wall_build":e===Be?"build_generator":"build"),!0}function zf(n,t){if(n<0||t<0){hn();return}const e=qn();for(const i of e){if(!i.alive||i.team!==st)continue;const s=Qt[i.type];if(s&&n>=i.col&&n<i.col+s.size&&t>=i.row&&t<i.row+s.size){s.levels?(gm(i),Yt("select")):hn();return}}hn()}function Fw(n){if(!n||!Xr(n))return;const t=bh(n);if(!tr(st,t)){Yt("denied");return}wh(n),Yt("build")}function Ow(n,t){if(!n||!qr(n))return;const e=vr(n,t);if(!tr(st,e)){Yt("denied");return}Th(n,t),Yt("build")}function Hf(n,t,e){if(n==="all")E_(st,t,e,Le);else if(n==="selection")cu(je,t,e);else{const i=ml(Number(n),Le);cu(i,t,e)}ys(null),Ss(null),Yt("heli_rally")}function Ks(){for(let t=0;t<je.length;t++)je[t].selected=!1;const n=Le();for(let t=0;t<n.length;t++)n[t].squadHighlight=!1;je=[]}function Bw(n){if(Ks(),!(!n||!n.alive||n.team!==st)&&(n.selected=!0,je=[n],n.squadId!=null)){const t=ml(n.squadId,Le);for(let i=0;i<t.length;i++)t[i].id!==n.id&&(t[i].squadHighlight=!0);const e=pl(n.squadId);if(e){const s=qn().find(a=>a.id===e.buildingId&&a.alive);s&&gm(s)}}}function zw(n,t,e,i){Ks();const s=Math.min(n,e),a=Math.max(n,e),r=Math.min(t,i),o=Math.max(t,i),d=Le(),c=[];for(let h=0;h<d.length;h++){const l=d[h];!l.alive||l.team!==st||l.isAir||l.x>=s&&l.x<=a&&l.z>=r&&l.z<=o&&(l.selected=!0,c.push(l))}je=c}function Hw(n){Ks();const t=ml(n,Le);for(let e=0;e<t.length;e++)t[e].selected=!0;je=t}function Gw(n,t){const e=Le();let i=null,s=Q0;for(let a=0;a<e.length;a++){const r=e[a];if(!r.alive||r.team!==st||r.isAir)continue;const o=se(n,t,r.x,r.z);o<s&&(s=o,i=r)}return i}function kw(n,t){const e=qn();for(const i of e)if(i.alive&&i.type===Wt&&i.col===n&&i.row===t)return i;return null}function Vw(n,t){const e=Ue(n-1,t)===Fn,i=Ue(n+1,t)===Fn,s=Ue(n,t-1)===Fn,a=Ue(n,t+1)===Fn,r=e||i,o=s||a;return r&&!o?na:o&&!r?ko:i&&a&&!e&&!s?Wd:e&&a&&!i&&!s?Xd:i&&s&&!e&&!a?kd:e&&s&&!i&&!a?Vd:r&&o?na:null}function bm(n){const t=new Set;for(const e of n){const i=`${e.col},${e.row}`;t.add(i);for(const[s,a]of[[-1,0],[1,0],[0,-1],[0,1]]){const r=e.col+s,o=e.row+a;Ue(r,o)===Fn&&t.add(`${r},${o}`)}}for(const e of t){const[i,s]=e.split(",").map(Number),a=kw(i,s);if(!a)continue;const r=Vw(i,s);r&&r!==a.orientation&&(fm(a,r),_h(a,He()))}}function wm(n,t,e){Er.push({team:n,targetX:t,targetZ:e,delayTimer:h_}),Yt("airstrike_confirm")}function Ww(n,t,e){const i=He(),s=n===st?Un+Ia:-Ia,a=n===st?-Ia:Un+Ia,r=t+(Math.random()-.5)*200,o=t-r,d=e-s,c=Math.sqrt(o*o+d*d),h=o/c,l=d/c,u=LE(n,i);u.position.set(r,qd,s),u.rotation.y=Math.atan2(h,l),Ha.push({team:n,targetX:t,targetZ:e,bomberX:r,bomberZ:s,exitZ:a,dirX:h,dirZ:l,mesh:u,impacted:!1}),Yt("airstrike_incoming")}function Xw(n,t,e){const i=Le(),s=qn();for(let a=i.length-1;a>=0;a--){const r=i[a];if(!r.alive)continue;const o=se(r.x,r.z,t,e);if(o>mr)continue;let d;if(o<=ca)d=da;else{const c=(o-ca)/(mr-ca);d=da+(ou-da)*c}r.hp-=d,r.hp<=0&&(r.isAir&&Sr()===r.id&&(Qi(null),wn()),tp(r),mm(r),yh(r,He()),Ci(r.x,r.z,r.team===st?zt.CYAN:zt.RED,"explosion"))}for(let a=s.length-1;a>=0;a--){const r=s[a];if(!r.alive)continue;const o=se(r.x,r.z,t,e);if(o>mr)continue;let d;if(o<=ca)d=da;else{const c=(o-ca)/(mr-ca);d=da+(ou-da)*c}if(r.hp-=d,r.hp<=0){const c=$d(r.id);c&&Tc(c.id,Le),Ah(r),Wr(r,He()),r.type===Wt?Ci(r.x,r.z,r.team===st?zt.CYAN:zt.RED,"wallBreak"):Ci(r.x,r.z,r.team===st?zt.CYAN:zt.RED,"bigExplosion"),rl()===r&&hn()}}}function qw(n){for(let t=Er.length-1;t>=0;t--){const e=Er[t];e.delayTimer-=n,e.delayTimer<=0&&(Ww(e.team,e.targetX,e.targetZ),Er.splice(t,1))}for(let t=Ha.length-1;t>=0;t--){const e=Ha[t],i=ru*n;if(e.bomberX+=e.dirX*i,e.bomberZ+=e.dirZ*i,e.mesh&&(e.mesh.position.x=e.bomberX,e.mesh.position.z=e.bomberZ,e.mesh.position.y=qd+Math.sin(Date.now()*.002)*3),!e.impacted&&se(e.bomberX,e.bomberZ,e.targetX,e.targetZ)<ru*n*2){e.impacted=!0;const o=e.team===st?zt.CYAN:zt.RED;Xw(e.team,e.targetX,e.targetZ),Ci(e.targetX,e.targetZ,o,"airStrike"),ZE(e.targetX,e.targetZ,o,mr/10),Yt("airstrike_explosion")}const s=e.team===st&&e.bomberZ<-Ia,a=e.team===Kt&&e.bomberZ>Un+Ia;(s||a)&&(e.mesh&&sm(e.mesh,He()),Ha.splice(t,1))}}function Tm(n){requestAnimationFrame(Tm);const t=n/1e3,e=Math.min(t-Of,.05);Of=t;const i=jo();if(i&&i.update(),Br===Ga){Xn+=e,v1(e),yb(e,{getBuildings:qn}),wb(e,Xn,{getEnergy:()=>Mr(Kt),spendEnergy:x=>tr(Kt,x),getBuildings:qn,getUnits:Le,createBuilding:(x,S,I)=>{const P=il(x,S,I,Kt);return Lr(P,He()),(x===Je||x===Xe||x===on)&&Qf(P.id,Kt,x),x===Wt&&bm([{col:S,row:I}]),P},isBuildable:(x,S,I)=>el(x,S,I,Kt),findPath:Io,canUpgradeTurret:KE,startTurretUpgrade:QE,canBranchTurret:JE,startTurretBranch:tb,canUpgradeBuilding:Xr,canBranchBuilding:qr,startUpgrade:wh,startBranch:Th,getUpgradeCost:bh,getBranchCost:vr,getIncomeBreakdown:()=>Cf(Kt),setHelicopterRally:Rd,canRepairWall:dm,startWallRepair:um,getRepairCost:hm,canAirStrike:x=>sl(x,Xn),initiateAirStrike:(x,S,I)=>wm(x,S,I),markAirStrikeUsed:x=>pm(x,Xn),getMatchTime:()=>Xn,getSquads:x=>du(x),getUnitsBySquad:x=>ml(x,Le),setUnitStance:Hr,setUnitTargetPriority:Zd,setUnitsStance:ep,setUnitsTargetPriority:np}),Ib(Xn,{getUnits:Le});const h=sb(e,Xn,{createUnit:(x,S,I,P,N,L)=>{const k=rb(x,S,I,P,N);return EE(k,He()),L!=null&&x_(k,L),P===Kt&&Nb(k),k},findPath:Io});for(const x of h)_h(x,He()),x.type===Wt&&x._justRepaired?(Ci(x.x,x.z,x.team===st?zt.CYAN:zt.RED,"wallRepair"),Yt("wall_repair"),x._justRepaired=!1):Yt("upgrade");_b(e,{getUnits:Le,getBuildings:qn,getProjectiles:Dd,getFirePoint:x=>q1(x),createProjectile:(x,S,I,P,N,L,k)=>{const B=hb(x,S,I,P,N,L,k);return B&&bf(B,He()),B},createHomingProjectile:(x,S,I,P,N,L,k,B,V,H,et)=>{const tt=ub(x,S,I,P,N,L,k,B,V,H,et);return tt&&bf(tt,He()),Yt("shoot_pulse"),tt},removeUnit:x=>{x.isAir&&Sr()===x.id&&(Qi(null),wn()),tp(x),mm(x),yh(x,He()),Ci(x.x,x.z,x.team===st?zt.CYAN:zt.RED,"explosion"),Yt("explosion")},removeBuilding:x=>{const S=$d(x.id);S&&Tc(S.id,Le),Ah(x),Wr(x,He()),x.type===Wt?(Ci(x.x,x.z,x.team===st?zt.CYAN:zt.RED,"wallBreak"),Yt("wall_break")):(Ci(x.x,x.z,x.team===st?zt.CYAN:zt.RED,"bigExplosion"),Yt("bigExplosion")),rl()===x&&hn()},spawnParticle:Ci}),ob(e,{findPath:Io,findPathThroughWalls:S1,getBuildings:qn,getUnits:Le,combatUnitHash:gb(),combatBuildingHash:xb()});const l=fb(e);for(const x of l)am(x,He());Cw(e),qw(e);const u=qn(),f=u.find(x=>x.type===Nn&&x.team===st),_=u.find(x=>x.type===Nn&&x.team===Kt);!_||_.hp<=0?(Ns(kf),Yt("victory")):(!f||f.hp<=0)&&(Ns(Vf),Yt("defeat"));let g=!1;if(f&&f.alive){const x=Le();for(let S=0;S<x.length;S++){const I=x[S];if(I.alive&&I.team===Kt&&se(I.x,I.z,f.x,f.z)<Ec){g=!0;break}}}g&&!Hd&&Yt("baseAlert"),Hd=g,Xn%1<e&&w_(Le),je=je.filter(x=>x.alive);for(let x=0;x<je.length;x++)je[x].alive||(je[x].selected=!1);const m=du(st),p=qn(),v=[];for(let x=0;x<m.length;x++){const S=m[x],I=p.find(P=>P.id===S.buildingId);if(!I||!I.alive){Tc(S.id,Le);continue}v.push({id:S.id,buildingId:S.buildingId,label:S.label,buildingType:S.buildingType,spawnStance:S.spawnStance,spawnTargetPriority:S.spawnTargetPriority,unitCount:b_(S,Le),buildingAlive:!0,rallyX:S.rallyX,rallyZ:S.rallyZ})}const M=zb(),y=fh(),T=jo();let b=null;if(y&&T){const x=y.position.distanceTo(T.target),S=y.fov*Math.PI/180,I=2*Math.tan(S/2)*x;b={x:T.target.x,z:T.target.z,viewWidth:I*y.aspect,viewHeight:I}}const A=Sr();A&&Cd().find(S=>S.id===A),Vb({energy:Mr(st),enemyEnergy:Mr(Kt),incomeBreakdown:Cf(st),buildings:u,units:Le(),matchTime:Xn,dt:e,baseUnderAttack:g,rallyActive:M.rallyActive,rallyHoldingCount:M.holdingCount,rallyPushSize:M.pushSize,rallyTimeRemaining:M.timeRemaining,obstacles:Sm,cameraInfo:b,squads:v,selectedUnitCount:je.length,selectionBoxScreen:yw(),airStrikePending:_w()!=null})}const s=qn(),a=Le(),r=Dd();oE(t,s),bE(t,a,Sr()),kE(t,r),YE(t,Ew()),jE(t);const o=ow();let d=null;if(o&&Br===Ga){const h=lw();if(h){const l=Qt[h];d={col:o.col,row:o.row,size:l?l.size:1}}}X1(t,d,vw()?xw():null);const c=_1();c&&c.render()}document.getElementById("btn-start").addEventListener("click",Ph);document.getElementById("btn-resume").addEventListener("click",()=>Ns(Ga));document.getElementById("btn-quit").addEventListener("click",()=>{Em(),Ns(dl)});document.getElementById("btn-restart-win").addEventListener("click",Ph);document.getElementById("btn-restart-lose").addEventListener("click",Ph);document.addEventListener("keydown",n=>{n.key==="Escape"&&(Br===Ga?Ns(Sc):Br===Sc&&Ns(Ga))});function Yw(){const n=document.getElementById("render-target");p1(n),tw(g1(),fh(),jo()),b1((e,i,s,a)=>{const r=e*J+J*s/2,o=i*J+J*s/2,d=Kh*Kh;for(const c of Le()){if(c.team!==a||c.isAir)continue;const h=c.x-r,l=c.z-o;if(h*h+l*l<=d)return!0}return!1}),cw((e,i,s)=>{if(e<0||!s){Ji(),vs(null);return}Bf(e,i,s)?(Ji(),vs(null)):(zf(e,i),rl()&&(Ji(),vs(null)))}),dw((e,i,s,a)=>{if(e===-2&&i===-2){const r=Sr();if(r){const d=Cd().find(c=>c.id===r);d&&(Ks(),hn(),Wb(d),Yt("heli_select"))}return}if(wn(),Qi(null),zf(e,i),rl()){Ks();return}if(s!=null&&a!=null){const r=Gw(s,a);if(r){Bw(r),Yt("select");return}}Ks(),hn()}),Mw((e,i,s,a)=>{wn(),Qi(null),hn(),zw(e,i,s,a),je.length>0&&Yt("select")}),uw((e,i,s)=>{Rd(e,i,s),wn(),Yt("heli_rally")}),fw(()=>Cd()),pw((e,i,s)=>{Hf(e,i,s)}),mw((e,i,s)=>{const r=qn().find(o=>o.id===e&&o.alive);if(!r||!sl(r,Xn)){Yt("denied");return}if(!tr(st,Va)){Yt("denied");return}pm(r,Xn),wm(st,i,s)}),gw(e=>{const i=[];for(const s of e)Bf(s.col,s.row,Wt)&&i.push(s);i.length>0&&bm(i)}),kb(document.getElementById("sidebar"),{onBuildSelect:e=>{hn(),vs(e),ys(null),Ss(null),Yt(e?"select":"cancel")},onBuildingUpgrade:e=>{Fw(e)},onBuildingBranch:(e,i)=>{Ow(e,i)},onPushNow:()=>{Hb(),Yt("select")},onMinimapClick:(e,i)=>{Gf(e,i)},onHelicopterRally:(e,i,s)=>{Rd(e,i,s),Yt("heli_rally")},onHeliDeselect:()=>{Qi(null),wn()},onSpawnStanceChange:(e,i)=>{v_(Number(e),i),Yt("select")},onSpawnTargetChange:(e,i)=>{M_(Number(e),i),Yt("select")},onSelectionStance:e=>{je.length>0&&ep(je,e),ys(null),Ss(null),Yt("select")},onSelectionTarget:e=>{je.length>0&&np(je,e),Yt("select")},onSelectionDeselect:()=>{Ks()},onSelectionRallyClick:()=>{ys("selection"),Ss("selection"),Ji(),vs(null),Qi(null),wn(),Yt("select")},onSquadCardClick:e=>{Hw(Number(e)),Yt("select")},onGlobalStance:e=>{y_(st,e,Le),ys(null),Ss(null),Yt("select")},onGlobalTarget:e=>{S_(st,e,Le),Yt("select")},onGlobalRallyClick:()=>{ys("all"),Ss("all"),Ji(),vs(null),Qi(null),wn(),Yt("select")},onRallySet:(e,i,s)=>{Hf(e,i,s)},onAirStrike:e=>{if(!(!e||!sl(e,Xn))){if(Mr(st)<Va){Yt("denied");return}Mm(e.id),qb(),Ji(),vs(null),Qi(null),wn(),ys(null),Ss(null),Yt("airstrike_confirm")}},onWallRepair:e=>{if(!e||!dm(e))return;const i=hm();if(!tr(st,i)){Yt("denied");return}um(e),Yt("wall_repair")},onWallDemolish:e=>{if(!e||e.type!==Wt||!e.alive)return;const i=eb(e);i>0&&Sb(st,i),Wr(e,He()),Ci(e.x,e.z,zt.CYAN,"wallBreak"),Yt("wall_break"),hn()},onWallOrient:(e,i)=>{!e||e.type!==Wt||!e.alive||(fm(e,i),_h(e,He()),Yt("select"))}}),qE(He()),$E(He()),ym();const t=yn(ws,es,J);hw(()=>{Gf(t.x,t.z)}),Ns(dl),requestAnimationFrame(Tm)}function Gf(n,t){const e=fh(),i=jo();if(!e||!i)return;const s=n-i.target.x,a=t-i.target.z;i.target.x=n,i.target.z=t,e.position.x+=s,e.position.z+=a}Yw();
